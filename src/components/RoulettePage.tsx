      ...
      <div className="container mx-auto px-4 py-4 md:py-8">
        ...
        <div className="grid grid-cols-3 gap-2 md:gap-6 max-w-4xl mx-auto mb-4 md:mb-8">
          {[0, 1, 2].map((index) => (
            <div
              key={index}
              className={`relative p-2 md:p-6 rounded-xl md:rounded-2xl border-2 transition-all duration-300 w-full aspect-[3/4] md:aspect-[3/4] ${
                isSpinning 
            ...
            >
              <div className="flex flex-col items-center justify-center h-full">
                {displayIcons[index] ? (
                  <>
                    <div className="w-6 h-6 md:w-16 md:h-16 text-foreground mb-1 md:mb-4">
                      <div
                    ...
                    <h3 className={`text-xs md:text-xl font-bold mb-0.5 md:mb-2 ${
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-xs md:text-xl font-bold text-foreground mb-0.5 md:mb-2">
                      Cherry
                    </h3>
                    <p className="text-xs md:text-base text-muted-foreground">
                      Fruit
